...
c <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
<!--[if lt IE 9]> --->
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">CS75 Finance</a></div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="topFixedNavbar1" style="max-width:1200px; align-content:center">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">LookUp<span class="sr-only">(current)</span></a></li>
        <li><a href="#">Profile</a></li>
        </ul>
      
      <ul class="nav navbar-nav navbar-right">
          
        <form class="navbar-form navbar-left" method="POST" action="index.php?page=login">
